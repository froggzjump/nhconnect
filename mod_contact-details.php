...
<!----- This script is for the collapsing sections on the right column ------>
...
<h2><?php echo $row_contact['contact_first']; ?> <?php echo $row_contact['contact_last']; ?><span style="color:#999999"> Currently assigned to: <?php echo $row_contactJ2['user_name'] . "<br>"; ?></span></h2>
