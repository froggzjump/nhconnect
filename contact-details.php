...
<h2><?php echo $row_contact['contact_first']; ?> <?php echo $row_contact['contact_last']; ?><span style="color:#999999"> 
        Currently assigned to: <?php echo $row_contactJ2['user_name'] . "<br>"; ?></span></h2>
<a href="contact.php?id=<?php echo $row_contact['contact_id']; ?>" class="button"><span class="edit">Edit Follow-Up info</span></a> 
<span class="numbers"><?php echo $contacted; ?> - Day:  <?php echo $numdays; ?></span>   
<br clear="all" /> 
</div>
