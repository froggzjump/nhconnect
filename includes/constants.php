<?php
define("DB_SERVER", "adminnhcf.db.3171530.hostedresource.com");
define("DB_USER", "adminnhcf");
define("DB_PASS", "Web12345nh");
define("DB_NAME", "adminnhcf");

define("TBL_USERS", "follows_users");
define("TBL_ACTIVE_USERS",  "active_users");
define("TBL_ACTIVE_GUESTS", "active_guests");
define("TBL_BANNED_USERS",  "banned_users");
define("TBL_FOLLOWS", "follows_contacts");
define("TBL_EMAIL", "follows_email");
define("TBL_GROUP", "follows_group");
define("TBL_NOTES", "follows_notes");
define("TBL_STAGES", "follows_stages");
define("TBL_CATEGORY", "category");
define("TBL_WAIT", "follows_wait");
