...
$query_check = "SELECT * FROM follows_contacts WHERE contact_id = $theid";
$check = mysql_query($query_check, $follows) or die("Error1" . mysql_error());
...
$contact = mysql_query($query_contact, $follows) or die("Error2" . mysql_error());
...
$notes = mysql_query($query_notes, $follows) or die("Error3" . mysql_error());
...
$note = mysql_query($query_note, $follows) or die("Error4" . mysql_error());
...
$checkhistory = mysql_query($query_checkhistory, $follows) or die("Error7" . mysql_error());
...
//For Counting days from followup start
	      $time_A = strtotime($row_contact['follow_date']);
...
<?php } ?>
<h2><?php echo $row_contact['contact_first']; ?> <?php echo $row_contact['contact_last']; ?>
<span style="color:#999999"> Currently Waiting in Queue-Group: <?php echo $row_contactJ2['user_name'] . "<br>"; ?></span></h2>
<a href="wcontact.php?id=<?php echo $row_contact['contact_id']; ?>" class="button"><span class="edit">Edit Follow-Up info</span></a> 
<span class="numbers">Day <?php echo $numdays;?></span>   
<br clear="all" /> 
</div>
