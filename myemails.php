...
$query_emails = "SELECT follows_contacts.*, follows_email.* 
		 ...
		 WHERE follows_contacts.contact_stage <> 9 AND contact_date > unix_timestamp(now() - interval 180 day) ORDER BY email_date DESC";
...
if ($row_userinfo['user_level'] != 1) {
mysql_select_db($database_follows, $follows);
$query_contacts = "SELECT * FROM follows_email WHERE worker_id = $whois AND email_date > unix_timestamp(now() - interval 180 day) $sorder" ;
...
<?php include('includes/header.php'); ?>
  ...
  <div class="leftcolumn">
    <h2><?php echo MINISTRY . " Email Notifications (" . $totalRows_emails . ")" ;?></h2> for <?php echo $row_userinfo['user_name']; ?>
