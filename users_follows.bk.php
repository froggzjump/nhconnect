...
$query_contacts = "SELECT * FROM follows_contacts WHERE contact_wait <> 1 AND contact_date > unix_timestamp(now() - interval 180 day) $sorder";
...
header('Location: contact.php');
        ...
        $mygroup = $row_userinfo['member_group_id'];
...
mysql_select_db($database_follows, $follows);
$query_contacts = "SELECT u.*, b.* FROM follows_contacts u JOIN follows_users b ON u.contact_user = b.user_id WHERE member_group_id = $mygroup AND contact_date > unix_timestamp(now() - interval 180 day) $sorder" ;
$follows = mysql_query($query_contacts, $follows) or die(mysql_error());
$row_contacts = mysql_fetch_assoc($follows);
$totalRows_contacts = mysql_num_rows($follows);
...
<?php include('includes/header.php'); ?>
  ...
  <div class="leftcolumn">
    <h2><?php echo "Follow-Ups for My Group (" . $totalRows_contacts . ")";?></h2> for <?php echo $row_userinfo['user_name']; ?>
